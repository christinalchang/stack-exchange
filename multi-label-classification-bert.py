...
train_data_path='./bio_train.csv'
train = pd.read_csv(train_data_path)
test = pd.read_csv('bio_test.csv')
unique = pd.read_pickle("bio_unique.dat")[0]
...
def file_based_input_fn_builder(input_file, seq_length, is_training,
    ...
    name_to_features = {
        ...
        "label_ids": tf.FixedLenFeature([655], tf.int64),
